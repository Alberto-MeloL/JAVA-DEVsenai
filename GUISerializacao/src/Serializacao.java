...
public static void serializar(String arquivo, List<Usuarios> usuarios) {
...
public static List<Usuarios> deserializar(String arquivo) {
try {
...
return (List<Usuarios>) inputStream.readObject();
